        ...
        <div className="max-w-6xl mx-auto space-y-10 pb-20 px-4">
            ...
            <div className="bg-primary text-white rounded-[2.5rem] p-12 shadow-2xl shadow-primary/20 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-2">
                    ...
                    <p className="text-blue-100 mt-2 text-xs font-bold uppercase tracking-widest opacity-80">
                        Top community members who help find and return items
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl p-8 border border-gray-100 dark:border-gray-800 transition-all hover:scale-[1.02]">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-widest">Your Points</p>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl p-8 border border-gray-100 dark:border-gray-800 transition-all hover:scale-[1.02]">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-widest">Your Rank</p>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl p-8 border border-gray-100 dark:border-gray-800 transition-all hover:scale-[1.02]">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-widest">Items Returned</p>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 rounded-[2.5rem] p-10 shadow-inner">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-xl">
                        ...
                        <p className="text-gray-400 dark:text-gray-500 font-black uppercase tracking-widest text-[10px]">Report found item</p>
                    </div>
                    <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-xl">
                        <p className="font-black text-primary text-2xl mb-1 tracking-tighter">+100 PTS</p>
                        <p className="text-gray-400 dark:text-gray-500 font-black uppercase tracking-widest text-[10px]">Return an item</p>
                    </div>
                    <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-800 shadow-xl">
                        <p className="font-black text-primary text-2xl mb-1 tracking-tighter">+100 PTS</p>
                        <p className="text-gray-400 dark:text-gray-500 font-black uppercase tracking-widest text-[10px]">Verify your identity</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-950 rounded-[3rem] shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div className="bg-gray-900 dark:bg-gray-900/50 text-white p-8 md:p-10 border-b border-gray-800">
                    ...
                    <p className="text-gray-400 text-[10px] mt-2 font-black uppercase tracking-[0.2em] opacity-80">Our most helpful community members</p>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Returned {user.itemsReturned || 0} items</p>
                                </div>
                                ...
                                <div className="text-right flex flex-col items-end mr-4">
                                    ...
                                    <p className="text-[10px] text-gray-400 dark:text-gray-500 uppercase font-black tracking-widest mt-1">Points</p>
                                </div>
            ...
            <div className="bg-primary text-white rounded-[2.5rem] p-12 text-center shadow-2xl shadow-primary/30 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl font-black mb-4 uppercase tracking-tighter">Climb the Leaderboard</h2>
                    <p className="text-blue-100 mb-10 max-w-lg font-medium opacity-90 leading-relaxed">
                        Every successfully returned item earns you points and trust within our community.
