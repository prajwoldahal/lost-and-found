...
export default function AdminPosts() {
    ...
    const fetchPosts = async () => {
        try {
            ...
            toast.error('Failed to load posts: ' + (error.response?.data?.error || error.message));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-8 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-5xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Post Archive</h1>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-gray-50/50 dark:bg-gray-900/50 text-gray-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">
                            <tr>
                                ...
                                <th className="px-6 py-5">Contributor</th>
                                ...
                                <tr key={post.id} className="hover:bg-primary/5 dark:hover:bg-primary/5 transition duration-150 group">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="font-bold text-gray-700 dark:text-gray-300 text-sm">{post.creatorName || 'Anonymous'}</span>
                                        </div>
                                    </td>
                    ...
                    {filteredPosts.length === 0 && (
                        <div className="p-20 text-center text-gray-400 dark:text-gray-600">
                            ...
                            <p className="font-black uppercase tracking-widest text-[10px]">No posts match your current filters.</p>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="bg-red-50 dark:bg-red-950/30 px-8 py-6 border-b border-red-100 dark:border-red-900/30 flex items-start justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight">Delete Post</h2>
                                    <p className="text-[11px] text-red-500 dark:text-red-400 font-bold uppercase tracking-widest mt-0.5">This action cannot be undone</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="px-8 pt-6 pb-2">
                            <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 mb-6">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest truncate">
                                        by {deleteModal.post?.creatorName || 'Unknown'} · {deleteModal.post?.type} · {deleteModal.post?.category}
                                    </p>
                                </div>
                            </div>
                            ...
                            <textarea
                                ...
                                placeholder="Explain why this post is being removed (e.g. spam, offensive content, duplicate post, policy violation...)"
                            ...
                            <p className="text-[10px] text-gray-400 dark:text-gray-500 font-bold mb-6">
                                This reason will be saved in the admin logs for accountability.
                            </p>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="bg-amber-50 dark:bg-amber-950/30 px-8 py-6 border-b border-amber-100 dark:border-amber-900/30 flex items-start justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight">Reject Post</h2>
                                    <p className="text-[11px] text-amber-500 dark:text-amber-400 font-bold uppercase tracking-widest mt-0.5">This post will be deleted</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="px-8 pt-6 pb-2">
                            <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 mb-6">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest truncate">
                                        by {rejectModal.post?.creatorName || 'Unknown'}
                                    </p>
                                </div>
                            </div>
                            ...
                            <textarea
                                ...
                                placeholder="Explain why this post is being rejected (the user will see this)..."
